...
def plot_2d_data(proj_data, params, labels):
    ...
    plt.savefig('results/oil_data/params_optimization/kmeans//kmeans_2D_{}.png'.format(utilities.algorithm_params_to_print(params)))
...
def plot_3d_data(proj_data, params, labels):
    ...
    plt.savefig('results/oil_data/params_optimization/kmeans/kmeans_3D_{}.png'.format(utilities.algorithm_params_to_print(params)))
